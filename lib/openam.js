...
exports.OpenAm.prototype.isTokenValid = function(token, callback) {
    request({
        ...
        method: 'POST',
        json: true,
        url: this._getTokenValidUrl(token),
    }, function(error, response, body) {
        if (error) {
            console.log(error);
            callback(false);
...
exports.OpenAm.prototype._getLogoutUrl = function(token) {
    return this._baseSite + "json/sessions/?_action=logout";
}

exports.OpenAm.prototype._getTokenValidUrl = function(token) {
    return this._baseSite + "json/sessions/" + token + "?_action=validate";
}
